...
//userId is the unique _id in MongoDB database.
//update user (put method: is to replace /:id content with the new one)
router.put("/:id", async (req,res) =>{
    ...
    if(req.body.userId === req.params.id || req.body.isAdmin) {
        ...
        try{
            // {$set:{field: value}} is to update field in MongoDB
            //req.body is to update all the content inside this res.body into the MongoDB
